// app/src/main/java/com/example/studentmanager_system/Activity/TeacherScheduleActivity.java
...
public class TeacherScheduleActivity extends AppCompatActivity {
    ...
    private void loadTeachingCourses() {
        ...
        var cursor = db.rawQuery(
                "SELECT * FROM " + myDatabaseHelper.COURSE_TABLE + " WHERE teacher_id=?",
        ...
        while (cursor.moveToNext()) {
            ...
            course.setTeacherName(getTeacherName(teacherId)); // 获取教师姓名
    ...
    private void setupBottomNavigation() {
        ...
        if (navHome != null) {
            navHome.setOnClickListener(v -> {
                // 跳转到教师主页
                Intent intent = new Intent(TeacherScheduleActivity.this, teacherActivity.class);
        ...
        if (navManage != null) {
            navManage.setOnClickListener(v -> {
                // 跳转到教师管理页面
                Intent intent = new Intent(TeacherScheduleActivity.this, TeacherManagementActivity.class);
                intent.putExtra("teacherId", teacherId);
                startActivity(intent);
                finish();
            });
        ...
        if (navProfile != null) {
            navProfile.setOnClickListener(v -> {
                // 跳转到教师个人资料页面
                Intent intent = new Intent(TeacherScheduleActivity.this, TeacherProfileActivity.class);
                intent.putExtra("teacherId", teacherId);
                startActivity(intent);
                finish();
            });
