...
import androidx.appcompat.app.AppCompatActivity;  // 使用AppCompatActivity替代Activity
 ...
 * 展示学生信息的activity
 */
public class studentinfoActivity extends AppCompatActivity {  // 继承自AppCompatActivity
