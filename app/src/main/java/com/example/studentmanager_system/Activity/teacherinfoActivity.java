...
public class teacherinfoActivity extends AppCompatActivity {
    ...
    private void initTeachers() {
        ...
        Cursor cursor = db.rawQuery("select * from " + myDatabaseHelper.TEACHER_TABLE + " order by id", null);
        ...
        while (cursor.moveToNext()) {
            ...
            teacherList.add(new Teacher(id, name, password, sex, phone, subject));
        }
        cursor.close();
    }
